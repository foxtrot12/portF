...
function Info() {
  ...
  return (
    <div className="flex dark:text-teal-400 font-bold font-mono items-center text-YOYO-600 h-full lg:w-4/12 w-2/3 text-xl lg-py-6 px-4 py-2 lg-px-12 opacity-60 bg-POP_BLACK-300">
      <div
