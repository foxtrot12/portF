...
function Info() {
  ...
  return (
    <div
      aria-label={INFO_TXT}
      className="flex gap-2 flex-col justify-center h-full lg:w-2/3 w-full lg-py-6 px-4 py-2 lg-px-12 bg-POP_WHITE-100 bg-opacity-20  dark:bg-opacity-60 dark:bg-POP_BLACK-300"
    >
      {currentTxt !== INFO_TXT && (
        <button
          aria-hidden={true}
          tabIndex={-1}
          className="flex justify-end items-center gap-2 dark:text-MANNA-500 text-POLI_PURPLE-500 font-extraLight"
          onClick={() => {
            setCurrentTxt(INFO_TXT);
          }}
        >
      ...
      <div
        ...
        className="font-bold  text-xl overflow-x-hidden dark:text-teal-400 text-PINK_PONG-600 sm:overflow-y-hidden overflow-y-auto flex"
      >
